...
CREATE TABLE [dbo].[Usuario](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[Nome] [varchar](50) NULL CONSTRAINT [DF__Usuario__Nome__00551192]  DEFAULT (NULL),
	[UserIdMembership] [uniqueidentifier] NOT NULL,
 CONSTRAINT [PK__Usuario__7F60ED59] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
ALTER TABLE [dbo].[UsuarioPonto]  WITH CHECK ADD  CONSTRAINT [FK__UsuarioPo__Usuar__2F10007B] FOREIGN KEY([UsuarioId])
REFERENCES [dbo].[Usuario] ([Id])
GO
ALTER TABLE [dbo].[UsuarioPonto] CHECK CONSTRAINT [FK__UsuarioPo__Usuar__2F10007B]
GO
