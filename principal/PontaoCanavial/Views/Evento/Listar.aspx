<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<Evento>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% foreach (var item in Model) { %>
        ...
        <tr>
            ...
            <td>
                <%= Html.Encode(String.Format("{0:g}", item.DataEvento)) %>
            </td>
            <td>
