<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Produto>" %>
...
<% using (Html.BeginForm("Incluir", "Produto", FormMethod.Post, new { enctype = "multipart/form-data" }))
   { %>
        ...
        <fieldset>
            ...
            <div class="editor-field">
                <%= Html.TextBoxFor(model => model.CategoriaID) %>
