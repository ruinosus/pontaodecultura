#region Auto-generated classes for PontaoCanavialDB database on 2010-02-11 20:38:36Z
...
//
// Auto-generated from PontaoCanavialDB on 2010-02-11 20:38:36Z
...
public partial class PontaoCanavialDB : DataContext
{
    ...
    public Table<Banner> Banner { get { return GetTable<Banner>(); } }
    public Table<Categoria> Categoria { get { return GetTable<Categoria>(); } }
    public Table<Evento> Evento { get { return GetTable<Evento>(); } }
    public Table<Galeria> Galeria { get { return GetTable<Galeria>(); } }
    public Table<Imagem> Imagem { get { return GetTable<Imagem>(); } }
    public Table<Newsletter> Newsletter { get { return GetTable<Newsletter>(); } }
    public Table<Noticia> Noticia { get { return GetTable<Noticia>(); } }
    public Table<Personalization> Personalization { get { return GetTable<Personalization>(); } }
    public Table<Ponto> Ponto { get { return GetTable<Ponto>(); } }
    public Table<Produto> Produto { get { return GetTable<Produto>(); } }
    public Table<Profiles> Profiles { get { return GetTable<Profiles>(); } }
    public Table<Projeto> Projeto { get { return GetTable<Projeto>(); } }
    public Table<Roles> Roles { get { return GetTable<Roles>(); } }
    public Table<SiteMap> SiteMap { get { return GetTable<SiteMap>(); } }
    public Table<Users> Users { get { return GetTable<Users>(); } }
    public Table<UsersInRoles> UsersInRoles { get { return GetTable<UsersInRoles>(); } }
    public Table<Usuario> Usuario { get { return GetTable<Usuario>(); } }
    public Table<UsuarioPonto> UsuarioPonto { get { return GetTable<UsuarioPonto>(); } }
    public Table<Video> Video { get { return GetTable<Video>(); } }
...
public partial class Categoria : INotifyPropertyChanging, INotifyPropertyChanged
{
    ...
    public Categoria()
    {
        _prodUtO = new EntitySet<Produto>(Produto_Attach, Produto_Detach);
        OnCreated();
    }
...
public partial class Evento : INotifyPropertyChanging, INotifyPropertyChanged
{
    ...
    private EntityRef<Usuario> _usUarIo;
    [Association(Storage = "_usUarIo", OtherKey = "ID", ThisKey = "UsuarioID", Name = "fk_evento_usuario1", IsForeignKey = true)]
    [DebuggerNonUserCode]
    public Usuario Usuario
    {
        get
        ...
        set
        {
            if (value != _usUarIo.Entity)
            {
                if (_usUarIo.Entity != null)
                {
                    var previousUsuario = _usUarIo.Entity;
                    _usUarIo.Entity = null;
                    previousUsuario.Evento.Remove(this);
                }
                _usUarIo.Entity = value;
                if (value != null)
                {
...
public partial class Imagem : INotifyPropertyChanging, INotifyPropertyChanged
{
    ...
    public Imagem()
    {
        _galeRiA = new EntityRef<Galeria>();
        _usUarIo = new EntityRef<Usuario>();
        OnCreated();
    }
...
public partial class Ponto : INotifyPropertyChanging, INotifyPropertyChanged
{
    ...
    public Ponto()
    {
        _banner = new EntitySet<Banner>(Banner_Attach, Banner_Detach);
        _eventO = new EntitySet<Evento>(Evento_Attach, Evento_Detach);
        _galeRiA = new EntitySet<Galeria>(Galeria_Attach, Galeria_Detach);
        _newsletter = new EntitySet<Newsletter>(Newsletter_Attach, Newsletter_Detach);
        _notIcIa = new EntitySet<Noticia>(Noticia_Attach, Noticia_Detach);
        _prodUtO = new EntitySet<Produto>(Produto_Attach, Produto_Detach);
        _proJetO = new EntitySet<Projeto>(Projeto_Attach, Projeto_Detach);
        _usUarIoPoNto = new EntitySet<UsuarioPonto>(UsuarioPonto_Attach, UsuarioPonto_Detach);
        _video = new EntitySet<Video>(Video_Attach, Video_Detach);
        OnCreated();
    }
...
public partial class Produto : INotifyPropertyChanging, INotifyPropertyChanged
{
    ...
    public Produto()
    {
        _catEgoRiA = new EntityRef<Categoria>();
        _poNto = new EntityRef<Ponto>();
        _usUarIo = new EntityRef<Usuario>();
        OnCreated();
    }
...
public partial class Usuario : INotifyPropertyChanging, INotifyPropertyChanged
{
    ...
    private EntitySet<Evento> _eventO;
    [Association(Storage = "_eventO", OtherKey = "UsuarioID", ThisKey = "ID", Name = "fk_evento_usuario1")]
    [DebuggerNonUserCode]
    public EntitySet<Evento> Evento
    {
        get
